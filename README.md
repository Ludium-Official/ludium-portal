...
[Bas Portal](https://bas-community.com/) is an open platform that makes digital work more **accessible**, **collaborative**, and **trustless**.
It provides infrastructure for milestone-based programs, verifiable work execution, and transparent talent discovery.
By shifting trust from people to systems, Bas enables anyone, anywhere, to collaborate without intermediaries.

---

## 🚀 What Is Bas Portal?

Bas Portal supports the full lifecycle of global digital talent.
It allows users to:
...
## 📊 Current Statistics _(as of Nov 2025)_
...
Bas Portal continues evolving into a trustless work automation layer supported by on-chain verification and structured program logic.
...
- **Portal Mainnet:** [bas portal](https://bas-community.com/)
...
Bas Portal is open-sourced under the **Business Source License (BUSL)**.
For more details:
[https://www.hashicorp.com/en/bsl](https://www.hashicorp.com/en/bsl)

---

👋 _Contributions are welcome via pull requests. For active tasks, see our Project Board._
**Talents Be Free.**
