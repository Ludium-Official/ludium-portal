      ...
      <Container>
        ...
        <div className="lg:col-span-2">
          <div className="flex items-center gap-2 w-full border-b border-gray-300">
            <Link to={`/programs/hackathon/${id}`} className={tabClass('details')}>
              Details
            </Link>
            <Link to={`/programs/hackathon/${id}?tab=buidls`} className={tabClass('buidls')}>
              BUIDLs
            </Link>
            <Link to={`/programs/hackathon/${id}?tab=hackers`} className={tabClass('hackers')}>
              Hackers
            </Link>
            <Link to={`/programs/hackathon/${id}?tab=tracks`} className={tabClass('tracks')}>
              Tracks
            </Link>
            <Link to={`/programs/hackathon/${id}?tab=faq`} className={tabClass('faq')}>
              FAQ
            </Link>
          </div>
