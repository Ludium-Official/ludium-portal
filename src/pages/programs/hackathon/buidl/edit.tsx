...
function HackathonBuidlEditPage() {
  ...
  return (
    <div className="bg-white w-full rounded-2xl">
      {isMobile && (
        <div className="fixed top-0 left-0 bg-white w-full z-50 border-b border-gray-100">
          <header className="relative flex items-center justify-center p-4 h-17">
            ...
            <span className="text-sm font-medium">Edit BUIDL</span>
            <Popover>
              ...
              <PopoverContent align="end" className="w-auto p-2 flex flex-col gap-1">
                ...
                >
                  {step < 2 ? 'Next' : loading ? 'Saving...' : 'Save BUIDL'}
                </Button>
              </PopoverContent>
            </Popover>
          </header>
      ...
      <Container className={cn('max-w-[856px] mx-auto py-10 px-4', isMobile && 'pt-25')}>
        <h1 className={cn('text-xl font-bold mb-6', isMobile && 'hidden')}>Edit BUIDL</h1>
