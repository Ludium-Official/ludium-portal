...
import { ArrowUpRight, CircleAlert, Settings, TrendingUp } from 'lucide-react';
    ...
    <div className="bg-[#F7F7F7]">
            ...
            <div className="flex items-center gap-4 mb-4 w-full">
              {program?.image ? (
                <img
                  src={program?.image}
                  alt="program"
                  className="min-w-[148px] aspect-square rounded-xl"
                />
              ) : (
                <div className="bg-slate-200 min-w-[148px] rounded-md aspect-square" />
              )}
      ...
      <section className="flex bg-white rounded-b-2xl">
        ...
        <div className="py-10 pr-5 flex-[33.3%] relative">
          ...
          <ScrollArea className="relative pr-2">
            {/* Terms Tab Content */}
            {activeTab === 'terms' && (
            ...
            <div className="sticky bottom-0 left-0 right-0">
              <Button
                className="w-full h-12 bg-primary hover:bg-primary/90 text-white font-medium flex items-center justify-center gap-2"
                onClick={() => {
