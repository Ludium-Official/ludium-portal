        ...
        <div className="mb-3">
          ...
          <Tabs value={selectedTab} onValueChange={handleTabChange}>
            <TabsList className={cn('rounded-md', isMobile && 'w-full')}>
              <TabsTrigger value="overview" className={cn('rounded-sm px-10', isMobile && 'px-4')}>
                Overview
              </TabsTrigger>
              <TabsTrigger
                value="applicants"
                className={cn('rounded-sm px-10', isMobile && 'px-4')}
              >
                Applicants
                <span className="text-primary font-bold">{program?.applicationCount}</span>
              </TabsTrigger>
              <TabsTrigger value="message" className={cn('rounded-sm px-10', isMobile && 'px-4')}>
                Message
              </TabsTrigger>
            </TabsList>
          </Tabs>
