      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-5">
        ...
        <div className={cn("grid grid-cols-2 gap-5", isMobile && "gap-[10px]")}>
          <Card className={cn("border-none shadow-none", isMobile && "gap-5")}>
            ...
            <CardContent
              className={cn("py-2 space-y-6", isMobile && "space-y-4")}
            >
              <div>
                ...
                <p className="text-xl font-semibold">
                  {commaNumber(
                    hiringActivityData?.hiringActivity?.openPrograms ?? 0
                  )}
                </p>
              </div>
              <div>
                ...
                <p className="text-xl font-semibold">
                  {commaNumber(
                    hiringActivityData?.hiringActivity?.ongoingPrograms ?? 0
                  )}
                </p>
              </div>
            </CardContent>
          ...
          <Card className={cn("border-none shadow-none", isMobile && "gap-5")}>
            ...
            >
              <div>
                ...
                <p className="text-xl font-semibold">
                  {commaNumber(
                    jobActivityData?.jobActivity?.appliedPrograms ?? 0
                  )}
                </p>
              </div>
              <div>
                ...
                <p className="text-xl font-semibold">
                  {commaNumber(
                    jobActivityData?.jobActivity?.ongoingPrograms ?? 0
                  )}
                </p>
              </div>
            </CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <PaymentOverview
          sponsorPaymentOverview={
            sponsorPaymentData?.sponsorPaymentOverview ?? []
          }
          builderPaymentOverview={
            builderPaymentData?.builderPaymentOverview ?? []
          }
        />
