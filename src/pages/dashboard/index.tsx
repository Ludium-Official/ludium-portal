        ...
        <Card className="border-none shadow-none">
          ...
          <CardContent className="py-2 space-y-6">
            <div>
              ...
              <p className="text-xl font-semibold">{commaNumber(mockHiringActivity.openProgram)}</p>
            </div>
            <div>
        ...
        <Card className="border-none shadow-none">
          ...
          <CardContent className="py-2 space-y-6">
            <div>
              ...
              <p className="text-xl font-semibold">{commaNumber(mockJobActivity.applied)}</p>
            </div>
            <div>
              <p className="font-light text-sm text-slate-500 mb-1">Ongoing Program</p>
              <p className="text-xl font-semibold">{commaNumber(mockJobActivity.ongoingProgram)}</p>
            </div>
          </CardContent>
        </Card>
      </div>
