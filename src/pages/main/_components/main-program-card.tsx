        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="space-y-2 flex-1 mb-3">
            <div className='bg-[#0000000A] rounded px-2 py-1 flex justify-between items-center gap-3'>
              ...
              <span className="text-xl text-primary font-bold flex items-center">25<span className='text-sm text-muted-foreground'>%</span></span>
            </div>
            ...
            <p className="text-sm text-gray-700 line-clamp-2 text-wrap max-w-[412px]">{program?.summary}</p>

          </div>
          <div className="flex items-center justify-end gap-2 mt-auto">
            <span className="text-sm text-secondary-foreground font-medium">Project Management</span>
