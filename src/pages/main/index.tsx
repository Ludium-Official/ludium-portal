...
function MainPage() {
  ...
  const { data: carouselItemsData, loading: carouselLoading } =
                ...
                <CarouselItem key={item.id}>
                  <section className="flex flex-col md:flex-row justify-between items-center mb-12 md:mb-20 gap-8">
                    <div className="max-w-full md:max-w-[50%] text-center md:text-left">
                      ...
                      <p className="text-base md:text-lg mb-6 md:mb-15">
                        {item.data?.summary}
                      </p>
                      <Button
                        type="button"
                        variant="purple"
                        className="w-[152px] h-11"
                        asChild
                      >
                        <Link
                          to={`${
        ...
        {programsLoading ? (
          ...
          <section className="mb-12">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 gap-2">
              <h2 className="text-xl md:text-2xl font-bold font-sans mb-0">
                Programs
              </h2>
              <Link
