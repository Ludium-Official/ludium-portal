  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#clip0)">
        ...
        <path d="M12.3735 16.4769V20.9971L18 13.2129L12.3735 16.4769Z" fill="white" fillOpacity="0.602" />
        <path d="M12.3735 20.9971V16.4761L6.75 13.2129L12.3735 20.9971Z" fill="white" />
        <path d="M12.3735 15.43L17.9963 12.1653L12.3735 9.6543V15.43Z" fill="white" fillOpacity="0.2" />
