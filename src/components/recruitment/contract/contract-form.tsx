  ...
  useEffect(() => {
    const fetchContractAmounts = async () => {
      if (onchainContractId && contract && currentContract?.address) {
        try {
          const onchainContractData = await contract.getContract(
            onchainContractId
          );
          ...
          <div className="space-y-6 text-sm leading-relaxed">
            <div>
              ...
              <p className="mb-2">
                ...
                &ldquo;Contract&rdquo;) is a project execution agreement between
                the Sponsor and the Builder through Ludium.
              </p>
              <p>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li>
                  ...
                  deadline according to the agreed scope and quality standards.
                </li>
                <li>
                  All deliverables must be the Builder&apos;s original work and
                  shall not infringe upon any third-party copyrights.
                </li>
                <li>
                  The Builder shall faithfully share progress updates during the
                  project and respond promptly to the Sponsor&apos;s feedback.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="mt-2">
                ...
                <p>
                  Intentional delays, unfaithful communication, or unauthorized
                  absence of contact shall be considered breach of contract.
                </p>
              </div>
                ...
                <div className="mb-3">
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-1">
                    <li>
                      ...
                      neglects communication, or the quality of deliverables is
                      significantly substandard, the Sponsor may request
                    ...
                    <li>
                      ...
                      faithfully re-perform and the Sponsor accepts, the Sponsor
                      may cancel the report.
                    </li>
                    <li>
                      If a subsequent report is filed for the same reason, the
                      platform shall immediately terminate the contract without
                      further mediation.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 mt-1">
                    ...
                    <li className="mb-2">
                      ...
                      invalidate the report and impose sanctions on the Sponsor.
                    </li>
                    <li>
            ...
            <div>
              ...
              <p>
                ...
                attempt resolution through the platform&apos;s internal dispute
                mediation system.
              </p>
              <p className="mt-2">
                If unresolved, smart contract records and on-chain transactions
                shall be used as final evidence and handled according to
            ...
            <div className="text-sm">
              {(() => {
                ...
                if (contractData?.totalAmount) {
                  const existingTotalAmount = Number.parseFloat(
                    contractData.totalAmount
                  );
                  const actualPaymentAmount =
                    newTotalPrice - existingTotalAmount;
